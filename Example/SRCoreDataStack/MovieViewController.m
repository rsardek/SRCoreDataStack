...
- (IBAction)addNewItemTapped:(id)sender
{
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        if ([lengths containsObject:[NSNumber numberWithInteger:0]])
        {
            ...
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"No movie added" message:@"Some fields missing" preferredStyle:UIAlertControllerStyleAlert];
